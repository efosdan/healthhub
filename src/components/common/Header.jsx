        ...
        <div className='w-[320px] p-4 ml-[-200px] mt-[120px] rounded-lg bg-white'>
          <div className='flex flex-col gap-3'>
            <div className='flex flex-row gap-1 items-center'>
              <div className='rounded-full flex items-center border-black justify-center w-4 h-4 border-2 border'>
                <div className='text- text-[12px] text-black font-bold'>?</div>
              </div>
            ...
            <div className='flex flex-col gap-1'>
              ...
              <span className=''>How can I make an appointment?</span>
              <span className=''>Share a document with my doctor</span>
            </div>
